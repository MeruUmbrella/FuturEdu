...
<body>
    ...
    <div class="d-flex justify-content-center flex-wrap">
        <a href="<?= URL_BASE ?>proprietario/perfilProprietario" class="btn-opcao btn-perfil" role="button" aria-label="Meu Perfil">
            <i class="bi bi-person-circle" aria-hidden="true"></i>
            Meu Perfil
        </a>
        <a href="<?= URL_BASE ?>imovel/meusImoveis" class="btn-opcao btn-favoritos" role="button" aria-label="Favoritos">
   <i class="bi bi-house" aria-hidden="true"></i>
    ...
    <div class="row mt-5">
        ...
        if (isset($conteudo)) {
            ...
            echo '<h2>Bem-vindo ào seu Dashboard!</h2>';
        }
        ?>
    </div>
</body>
